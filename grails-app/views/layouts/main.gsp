...
<body class="h-screen w-screen">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        <div>
                            <sec:ifNotLoggedIn>
                                <g:link class="btn primary-btn " controller="login" action="auth">
                                    Login</g:link>
                            </sec:ifNotLoggedIn>
                            <sec:ifLoggedIn>
                                <button type="button"
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="/user/edit/${springSecurityService?.currentUser?.id}"
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <g:link controller="message" action="index"
                            ...
                            <g:if test="${   Message.countByDestAndIsRead(springSecurityService.currentUser, false)>0 }">
                            <span
                                class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">
                                ${Message.countByDestAndIsRead(springSecurityService.currentUser, false)}
                            </span>
                            </g:if>
                        </g:link>
                    </li>
    ...
    <sec:ifLoggedIn>
     <div class="p-4 sm:ml-64">
        <div class="p-4 rounded-lg dark:border-gray-700 pt-20 w-screen h-screen">
            <g:layoutBody />
        </div>
    </div>
    </sec:ifLoggedIn>
