...
![Capture d'écran 1](src/docs/screenshots/grails_login.png)
...
![Capture d'écran 6](src/docs/screenshots/grails_saleAds_create.png)

#### /show

![Capture d'écran 6](src/docs/screenshots/grails_saleAds_show.png)

### Gestion des categories

#### /index

![Capture d'écran 7](src/docs/screenshots/grails_categories.png)

#### /create

![Capture d'écran 8](src/docs/screenshots/grails_categories_create.png)
...
- Associer les annonces à des catégories.
...
| ROLE_CLIENT | - Gestion de son compte.<br> - Création, modification et suppression de ses propres annonces. <br> - Envoi et lecture de ses messages. <br> - Voir toutes les annonces. |
